...
function Loader({bgColor}: LoaderBg) {
    return (
        <div className="loader-container" style={{ backgroundColor: bgColor }}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" width="80" height="80">
                ...
                <circle style={{ transformOrigin: "center" }} fill="none" stroke="url(#a9)" strokeWidth="15" strokeLinecap="round" strokeDasharray="200 1000" strokeDashoffset="0" cx="100" cy="100" r="70">
